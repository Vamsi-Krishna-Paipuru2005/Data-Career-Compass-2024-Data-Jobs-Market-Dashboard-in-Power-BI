...
### Dashboard File
You can find the file for the dashboard here: [`Data_Jobs_Dashboard_2pbix`](Data_Jobs_Dashboard_2.pbix).  
...
![Data Jobs Dashboard 2.0](images/Project2_Dashboard_Page1.png) 
